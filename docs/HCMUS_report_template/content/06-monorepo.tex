...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{img/09-jenkins-console-detect-modules.png}
    \caption{Console output hiển thị tính năng Path Filter nhận diện các module thay đổi}
\end{figure}
